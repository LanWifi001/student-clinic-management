            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('medicines.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="quantity" id="quantity" value="{{ old('quantity') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="flex items-center justify-end">
                        <a href="{{ route('medicines.index') }}" class="text-gray-500 hover:text-gray-700">
                            Cancel
                        </a>
